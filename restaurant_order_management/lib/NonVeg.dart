      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              Pin(start: -13.0, end: -23.9),
              Pin(size: 153.1, start: 77.5),
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
            ...
            Pinned.fromPins(
              Pin(size: 39.3, start: 49.5),
              Pin(size: 14.6, start: 55.2),
              child: SvgPicture.string(
                _svg_q94ojy,
                allowDrawingOutsideViewBox: true,
                fit: BoxFit.fill,
            ...
            Pinned.fromPins(
              Pin(size: 142.7, start: 17.3),
              Pin(size: 129.3, middle: 0.5369),
              child:
            ...
            Pinned.fromPins(
              Pin(size: 99.0, start: 43.0),
              Pin(size: 20.0, middle: 0.6465),
              child: Text(
                'Chicken Pasta',
                style: TextStyle(
                  fontFamily: 'Berkshire Swash',
            ...
            Pinned.fromPins(
              Pin(size: 142.3, end: 31.0),
              Pin(size: 112.7, middle: 0.5148),
              child:
                ...
                child: Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image:
                          const AssetImage('assets/images/chicken_biriyani.png'),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
