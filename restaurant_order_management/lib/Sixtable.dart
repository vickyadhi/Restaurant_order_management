      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              Pin(size: 26.8, middle: 0.3693),
              Pin(size: 21.7, middle: 0.3084),
              child: Transform.rotate(
                angle: -1.5708,
                child: Stack(
                  children: <Widget>[
            ...
            Pinned.fromPins(
              Pin(size: 26.8, middle: 0.6249),
              Pin(size: 21.7, middle: 0.3072),
              child: Transform.rotate(
                angle: 1.5708,
                child: Stack(
                  children: <Widget>[
