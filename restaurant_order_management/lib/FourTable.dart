    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 37.0, middle: 0.4852),
            Pin(size: 68.0, middle: 0.1962),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(12.0),
          ...
          Pinned.fromPins(
            Pin(size: 26.8, middle: 0.3722),
            Pin(size: 21.7, middle: 0.2388),
            child: Transform.rotate(
              angle: -1.5708,
              child: Stack(
                children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 26.8, middle: 0.5946),
            Pin(size: 21.7, middle: 0.1879),
            child: Transform.rotate(
              angle: 1.5708,
              child: Stack(
                children: <Widget>[
