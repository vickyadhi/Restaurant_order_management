      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              Pin(start: -15.0, end: -22.3),
              Pin(size: 150.0, start: 121.5),
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
            ...
            Pinned.fromPins(
              Pin(size: 39.3, middle: 0.5138),
              Pin(size: 14.6, start: 87.2),
              child: SvgPicture.string(
                _svg_z89oqg,
                allowDrawingOutsideViewBox: true,
                fit: BoxFit.fill,
            ...
            Pinned.fromPins(
              Pin(size: 40.4, start: 23.6),
              Pin(size: 40.4, start: 45.8),
              child:
                  // Adobe XD layer: 'user' (group)
                  IconButton(
                    onPressed: (){
                      showDialog(context: context, builder: (ctx)=>
                      AlertDialog(content: Text("Are you sure you want to Logout?"),actions: [
            ...
            Pinned.fromPins(
              Pin(size: 145.0, start: 17.0),
              Pin(size: 87.0, middle: 0.5655),
              child:
                  // Adobe XD layer: 'veg' (shape)
                  Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: const AssetImage('assets/images/veg.png'),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Pinned.fromPins(
              Pin(size: 148.0, start: 17.0),
              Pin(size: 111.0, middle: 0.5792),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    transition: LinkTransition.Fade,
            ...
            Pinned.fromPins(
              Pin(size: 145.0, end: 18.0),
              Pin(size: 87.0, middle: 0.5655),
              child:
                  // Adobe XD layer: 'curry' (shape)
                  Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: const AssetImage('assets/images/non_veg.png'),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
...
const String _svg_n2xr8h =
    '<svg viewBox="0.0 0.0 22.4 22.4" ><path transform="translate(0.0, 0.0)" d="M 19.1025390625 14.46743965148926 C 17.88374710083008 13.24869155883789 16.43306732177734 12.34645366668701 14.8502950668335 11.8002872467041 C 16.54549407958984 10.63272476196289 17.65920448303223 8.678715705871582 17.65920448303223 6.469215869903564 C 17.65920448303223 2.902098655700684 14.75710391998291 0 11.18998718261719 0 C 7.622871398925781 0 4.720771789550781 2.902098655700684 4.720771789550781 6.469215869903564 C 4.720771789550781 8.678715705871582 5.83448314666748 10.63272476196289 7.529722690582275 11.8002872467041 C 5.946950912475586 12.34645366668701 4.496272087097168 13.24869155883789 3.277480840682983 14.46743965148926 C 1.163970947265625 16.58099365234375 -7.070546416798607e-06 19.39103698730469 -7.070546416798607e-06 22.37998962402344 L 1.748429536819458 22.37998962402344 C 1.748429536819458 17.17388725280762 5.98388671875 12.93843173980713 11.18998718261719 12.93843173980713 C 16.39608955383301 12.93843173980713 20.63154792785645 17.17388725280762 20.63154792785645 22.37998962402344 L 22.37998390197754 22.37998962402344 C 22.37998390197754 19.39103698730469 21.21600532531738 16.58099365234375 19.1025390625 14.46743965148926 Z M 11.18998718261719 11.18999481201172 C 8.586958885192871 11.18999481201172 6.46920919418335 9.072288513183594 6.46920919418335 6.469215869903564 C 6.46920919418335 3.866143226623535 8.586958885192871 1.748436689376831 11.18998718261719 1.748436689376831 C 13.7930154800415 1.748436689376831 15.9107666015625 3.866143226623535 15.9107666015625 6.469215869903564 C 15.9107666015625 9.072288513183594 13.7930154800415 11.18999481201172 11.18998718261719 11.18999481201172 Z" fill="#5d5d5d" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
